...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AttitudeIndicator_t, stringdata) + ofs \
...
const QMetaObject AttitudeIndicator::staticMetaObject = {
    { &QwtDial::staticMetaObject, qt_meta_stringdata_AttitudeIndicator.data,
      qt_meta_data_AttitudeIndicator,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AttitudeIndicator.stringdata))
