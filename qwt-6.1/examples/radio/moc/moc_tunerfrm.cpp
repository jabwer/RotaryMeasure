...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TunerFrame_t, stringdata) + ofs \
...
void TunerFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TunerFrame::fieldChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TunerFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_TunerFrame.data,
      qt_meta_data_TunerFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TunerFrame.stringdata))
