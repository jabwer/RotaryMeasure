...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DialBox_t, stringdata) + ofs \
...
const QMetaObject DialBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DialBox.data,
      qt_meta_data_DialBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialBox.stringdata))
