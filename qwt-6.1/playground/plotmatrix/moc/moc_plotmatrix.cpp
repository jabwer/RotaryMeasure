...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PlotMatrix_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 27, 0)
    ...
    "PlotMatrix\0scaleDivChanged\0\0"
};
...
const QMetaObject PlotMatrix::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_PlotMatrix.data,
      qt_meta_data_PlotMatrix,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlotMatrix.stringdata))
