...
**
** Created: Fri 4. Nov 14:21:15 2011
...
public:
    ...
    {
        pixmapDialog->setWindowTitle(QApplication::translate("pixmapDialog", "Pixmap", 0));
        chooseButton->setText(QApplication::translate("pixmapDialog", "Choose", 0));
        clearButton->setText(QApplication::translate("pixmapDialog", "Clear", 0));
        pushButton->setText(QApplication::translate("pixmapDialog", "&Ok", 0));
        pushButton_2->setText(QApplication::translate("pixmapDialog", "&Cancel", 0));
    } // retranslateUi
