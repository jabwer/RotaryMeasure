...
**
** Created: Fri 4. Nov 14:20:50 2011
...
public:
    ...
    {
        metricFontDialog->setWindowTitle(QApplication::translate("metricFontDialog", "Font", 0));
        label->setText(QApplication::translate("metricFontDialog", "Writing systems:", 0));
        groupBox->setTitle(QApplication::translate("metricFontDialog", "Font families", 0));
        groupBox_2->setTitle(QApplication::translate("metricFontDialog", "Font style", 0));
        groupBox_3->setTitle(QApplication::translate("metricFontDialog", "Font size (mm)", 0));
        groupBox_4->setTitle(QApplication::translate("metricFontDialog", "Font effects", 0));
        strikeoutCheckBox->setText(QApplication::translate("metricFontDialog", "Strikeout", 0));
        underlineCheckBox->setText(QApplication::translate("metricFontDialog", "Underline", 0));
        groupBox_5->setTitle(QApplication::translate("metricFontDialog", "Font sample", 0));
        label_2->setText(QApplication::translate("metricFontDialog", "Font writing systems:", 0));
    } // retranslateUi
