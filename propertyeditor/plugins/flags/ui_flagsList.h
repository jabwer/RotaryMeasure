...
**
** Created: Fri 4. Nov 14:21:04 2011
...
public:
    ...
    {
        flagsDialog->setWindowTitle(QApplication::translate("flagsDialog", "Flags", 0));
        checkAllButton->setText(QApplication::translate("flagsDialog", "C&heck all", 0));
        uncheckAllButton->setText(QApplication::translate("flagsDialog", "&Uncheck all", 0));
        pushButton->setText(QApplication::translate("flagsDialog", "&OK", 0));
        pushButton_2->setText(QApplication::translate("flagsDialog", "&Cancel", 0));
    } // retranslateUi
