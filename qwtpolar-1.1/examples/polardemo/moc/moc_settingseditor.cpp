...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SettingsEditor_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 12)
    ...
    "SettingsEditor\0edited\0\0PlotSettings\0"
};
...
const QMetaObject SettingsEditor::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_SettingsEditor.data,
      qt_meta_data_SettingsEditor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingsEditor.stringdata))
