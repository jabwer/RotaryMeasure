...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QwtPolarPanner_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 28, 2)
    ...
    "QwtPolarPanner\0movePlot\0\0dx\0dy\0"
};
...
const QMetaObject QwtPolarPanner::staticMetaObject = {
    { &QwtPanner::staticMetaObject, qt_meta_stringdata_QwtPolarPanner.data,
      qt_meta_data_QwtPolarPanner,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QwtPolarPanner.stringdata))
