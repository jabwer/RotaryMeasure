...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QwtPolarCanvas_t, stringdata) + ofs \
...
const QMetaObject QwtPolarCanvas::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QwtPolarCanvas.data,
      qt_meta_data_QwtPolarCanvas,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QwtPolarCanvas.stringdata))
