...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QwtPolarMagnifier_t, stringdata) + ofs \
...
const QMetaObject QwtPolarMagnifier::staticMetaObject = {
    { &QwtMagnifier::staticMetaObject, qt_meta_stringdata_QwtPolarMagnifier.data,
      qt_meta_data_QwtPolarMagnifier,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QwtPolarMagnifier.stringdata))
